describe('Login, Navigate to Account Toevoegen, and and test if email is already taken (error)', () => {
  it('should log in, navigate to account toevoegen, and add a new account and test the error id the email is already taken', () => {
